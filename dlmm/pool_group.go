...
// PoolGroup represents a group of DLMM pools that share the same token pair.
// Groups aggregate metrics across all pools for the pair, regardless of bin step.
