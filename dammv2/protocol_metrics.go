...
// ProtocolMetrics holds protocol-wide aggregate metrics for all DAMM v2 pools.
// Retrieved from the /stats/protocol_metrics endpoint.
type ProtocolMetrics struct {
	// TotalTVL is the total value locked across all DAMM v2 pools in USD.
	...
	// TotalPools is the total number of DAMM v2 pools.
